...
1. **Clone the repository**
   ```bash
   git clone https://github.com/erkanalperen54-boop/erkanalperen54-boop.github.io.git
   cd erkanalperen54-boop.github.io
   ```
...
1. **Fork the repository**
   ```bash
   git clone https://github.com/YourUsername/erkanalperen54-boop.github.io.git
   ```
...
### Email
- **Primary**: erkanalperen54@gmail.com
- **Business Inquiries**: alperenerkan@alperenerkan.com

### Social Media & Professional Networks
- **GitHub**: [@Alperen-Erkan](https://github.com/erkanalperen54)


### Contact Form
Visit the [Contact Page](contact.html) to send a message directly.
- e-mail : erkanalperen54@gmail.com
